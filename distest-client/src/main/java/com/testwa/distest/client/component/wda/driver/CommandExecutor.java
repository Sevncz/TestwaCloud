...
public interface CommandExecutor {
     ...
     * @see RemoteResponse
     */
    RemoteResponse execute(String command, Map<WDACommand.Wildcard, String> wildcards, Map<String, ?> parameters);
     ...
     * @see RemoteResponse
     */
    RemoteResponse execute(String command, Map<WDACommand.Wildcard, String> wildcards);
