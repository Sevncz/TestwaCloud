 ...
 */
@Slf4j
public class IOSScreenServer4 extends Thread implements Closeable {
    ...
    public IOSScreenServer4(int port) {
        super("wda-client");
        try {
...
//        }
    ...
    public static void main(String[] args) {
        IOSScreenServer4 screenServer3 = new IOSScreenServer4(9002);
        screenServer3.start();
    }
