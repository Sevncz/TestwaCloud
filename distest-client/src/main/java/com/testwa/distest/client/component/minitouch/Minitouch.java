...
public class Minitouch {
    ...
    public Minitouch(String deviceId, String resourcePath) {
...
//            ADBTools.chmod(deviceId, MINITOUCH_NOPIE_TMP_DIR, "777");
    ...
    public void sendEvent(String command) throws IOException {
        if(this.client != null) {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        Minitouch minitouch = new Minitouch(deviceId, resourcePath);
        minitouch.start();
