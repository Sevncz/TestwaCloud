...
public class WDACommand {
    ...
    public static RemoteCommandInfo get(String url) {
        return new RemoteCommandInfo(url, RemoteCommandInfo.HttpMethod.GET);
    }

    public static RemoteCommandInfo post(String url) {
        return new RemoteCommandInfo(url, RemoteCommandInfo.HttpMethod.POST);
    }

    public static RemoteCommandInfo delete(String url) {
        return new RemoteCommandInfo(url, RemoteCommandInfo.HttpMethod.DELETE);
    }
